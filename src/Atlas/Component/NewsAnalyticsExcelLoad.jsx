     ...
     const [excelData, setExcelData] = useState([]);
        ...
        for (const row of newData) {
          ...
          try {
            ...
            const response = await axios.get(
              `${API.CLIENT_URL}/solr/news_analytics/select`,
              {
      ...
      const handleSubmit = async () => {
        ...
        try {
          ...
          // Call generateHtmlPages after successful Solr submission
...
export default NewsAnalyticsExcelLoad